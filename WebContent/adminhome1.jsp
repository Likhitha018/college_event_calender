...
Connection con3=DriverManager.getConnection("jdbc:mysql://localhost:3306/trainingcalender","root","root");
Statement stmt3=con3.createStatement();
ResultSet rs3=stmt3.executeQuery("select * from workshop");
while(rs3.next())
{
	
	String DATE_FORMAT = "yyyy-MM-dd";
	SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT);
	Date d=sdf.parse(rs3.getString(7));
	Date d1=sdf.parse(rs3.getString(8));
	...
	//my code
	String fdate=rs3.getString(7);	
	
    String[] s=rs3.getString(7).split("-");
...
%>
<%
PreparedStatement stmt4=con3.prepareStatement("select * from projects");
...
while(rs4.next()){
	...
	Date d=sdf.parse(rs4.getString(7));	
	Date d1=sdf.parse(rs4.getString(8));
	String msg=rs4.getString(2);
	...
	//my code
	String fdate=rs4.getString(7);	
	String[] s=rs4.getString(7).split("-");
	//end my code
	%>
