...
var textclr = '#2F4F4F'; // text colour
	...
	<div id="templatemo_container">
    	<div id="templatemo_content_area">
        	...
        	<div id="templaetmo_left">
                ...
                <div class="templatemo_menu">
                	<ul>
						...
						<li><a href="#" target="_parent" onclick="facultyhome('event')">Add/Edit Events</a></li>
						<li><a href="#" target="_parent" onclick="facultyhome('delete')">Delete Events</a></li>
        	...
        	<div class="cleaner"></div>
                ...
                <div id="middle" style="top: 160px;position: absolute; left: 500px;" >
                <%if(session.getAttribute("save")!=null) {%>
Event  Already Exist  Try Again1<%} %></div>
