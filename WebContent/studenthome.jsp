...
for(dex=0; dex < 7; dex++) 
{
	...
	} cal += '<\/tr><tr>'; var day2 = today; for (dex = today; dex > 6; dex -=7) day2 = dex; weekday -= day2 - 1; while (weekday < 0) weekday += 7; for(dex=0; dex < weekday; dex++) cal += td_start + ' <\/td>'; for(dex=1; dex <= daysInMonth; dex++) {if(weekday == 7) {cal += '</tr><tr>'; weekday = 0;} 
    	...
    	<div id="templatemo_content_area">
        	<div id="templaetmo_left">
                ...
                <div class="templatemo_menu">
                	<ul>
						<li><a href="#" class="current" onclick="studentpage('home')">Home</a></li>
						<li><a href="#" onclick="studentpage('about')">About Us</a></li>
						<li><a href="#" onclick="studentpage('contact')">Contact</a></li>
            ...
            <div id="templaetmo_right">
            	<div id="templaetmo_right_top">
                	...
                	<div id="calendar" style="top: 120px;right: 30px;position: absolute;">
								...
								<div id="calDate"
									style="border: 1pt solid #cccccc; width: 238px;color:#2F4F4F">
									
									20130629:<br> Important Notifications
								</div>
								<div id="cal">
									<div id="cal">
        	...
        	<div class="cleaner"></div>
                ...
                <div id="middle" style="top: 160px;position: absolute; left: 450px;" ></div>
